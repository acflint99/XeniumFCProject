...
run_label_transfer <- function(sample_name,
  ...
  # ----------------------------
  tables_dir <- here(output_root, "XeniumABTTables")
  ...
  # ----------------------------
  plots_dir <- here(output_root, "XeniumABTPlots")
  ...
  # ----------------------------
    output_file <- here(output_root, "XeniumABT_RDS", paste0(sample_name, "_", reference_name, "_annotated.rds"))
