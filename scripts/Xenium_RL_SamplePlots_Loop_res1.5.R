...
source(here("scripts", "Xenium_RL_SamplePlots_res1.5.R"))
...
# 3. Define Paths
input_base <- here("outputs", "Xenium_AldingerABT_VZ&RLsubclusters_QC_Res1.5_RDS")
output_base <- here("outputs", "Xenium_AldingerABT_RLsubcluster_Res1.5_Results")
...
for (s in samples_to_run) {
  ...
  input_path <- file.path(input_base, paste0(s, "_Ald_VZ_RL_QC_Subclusters.rds"))
