...
subset_path <- here("outputs", "XenAld_RL_Subsets_Res1.5_RDS")
...
names(subsets) <- gsub("_RLsubset.rds", "", basename(subset_files))
...
saveRDS(merged_obj, 
        here("outputs", "XenAld_RL_Subsets_Res1.5_RDS", "Merged", "Xenium_Merged_RLSubsets_33026.rds"), #edit date if redo
        compress = FALSE)
