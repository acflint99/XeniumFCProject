...
ggsave(filename = file.path(plot_dir, paste0("Aldinger_VZ_VZClusterUMAP.png")), 
...
ggsave(filename = file.path(plot_dir, paste0("Aldinger_VZ_RawCluster_UMAP_Res_0.8.png")), 
