...
for(res in res_list) {
  ...
  ggsave(filename = file.path(plot_dir, paste0("XenAld_RL_UMAP_Res_", res, ".tif")), 
...
ggsave(filename = file.path(plot_dir, "XenAld_RL_Batch_Comp_UMAP.tif"), 
...
# 3. Save the Plot
ggsave(filename = file.path(plot_dir, "XenAld_RL_OrigClusterWeighted_UMAP.tif"), 
