...
generate_spatial_reports <- function(sample_id, input_rds_path, base_plot_dir) {
  ...
  ggsave(file.path(sample_plot_dir, paste0(sample_id, "_Global_Spatial1.5.png")),
  ...
  save_highlight(obj, c("VZPs", "Maturing PCs", "Early-born PCs", "Late-born PCs", "Patterning PCs"),
                 "Purkinje_Lineage", paste0(sample_id, "_Purkinje_Spatial1.5.png"))
  save_highlight(obj, c("VZPs", "RG Progenitors", "BG", "Astrocytes/Ependyma"),
                 "Glia_Lineage", paste0(sample_id, "_Glia_Spatial1.5.png"))
  save_highlight(obj, c("VZPs", "GABA Progenitors", "Golgi Cells", "MLIs", "iCN"),
                 "GABA_Lineage", paste0(sample_id, "_GABA_Spatial1.5.png"))
  ...
  ggsave(file.path(sample_plot_dir, paste0(sample_id, "_Markers_DotPlot.png")),
         plot = p_dot, width = 14, height = 7, dpi = 300)
