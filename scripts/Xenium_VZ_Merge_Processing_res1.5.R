...
plot_dir <- here("outputs", "XenAld_VZ_Res1.5_Plots")
rds_dir  <- here("outputs", "XenAld_VZ_Res1.5_RDS")

if (!dir.exists(plot_dir)) dir.create(plot_dir, recursive = TRUE)
if (!dir.exists(rds_dir))  dir.create(rds_dir, recursive = TRUE)

# 3. LOAD DATA
merged_path <- here("outputs", "XenAld_VZ_Subsets_Res1.5_RDS", "Merged", "Xenium_Merged_VZSubsets_32626.rds") #modify with correct object
...
# 9. SAVE FINAL RESULT
# Final RDS Save
output_path <- file.path(rds_dir, "Xenium_VZ_Res1.5_32726.rds")
