...
subset_path <- here("outputs", "XenAld_VZ_Subsets_Res1.5_RDS")
...
saveRDS(merged_obj, 
        here("outputs", "XenAld_VZ_Subsets_Res1.5_RDS", "Merged", "Xenium_Merged_VZSubsets_32626.rds"), #edit date if redo
        compress = FALSE)
