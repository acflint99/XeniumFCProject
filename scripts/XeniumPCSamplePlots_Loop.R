...
source(here("scripts", "Xenium_PC_SamplePlots.R"))
...
# 3. Define Paths
input_base <- here("outputs", "XeniumAldingerABT_PCsubcluster_RDS")
output_base <- here("outputs", "XeniumAldingerABT_PCsubcluster_Results")
...
for (s in samples_to_run) {
  ...
  input_path <- file.path(input_base, paste0(s, "_Ald_PC.rds"))
